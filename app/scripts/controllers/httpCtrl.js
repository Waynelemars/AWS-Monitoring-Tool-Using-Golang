...
angular.module('sbAdminApp')
  .controller('HttpCtrl', ['$scope', '$timeout', '$http' , function ($scope, $timeout,$http) {
			...
			for(var i=0 ; i< count ; i++) {
				...
				if(i+1!=cnt) {
					...
					console.log("j is", j);
					    ...
					    metricArray.push(response[i].Datapoints[j].Sum);
					 ...
					 console.log("j is", j);
						//dataArray.push(response[i].Datapoints[j].Timestamp);
					    metricArrayTwo.push(response[i].Datapoints[j].Sum);
